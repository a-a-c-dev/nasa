  ...
  return (
    <nav className='navbar'>
      ...
      <ul className={isActive?'nav-menu active':'nav-menu'}>
        <li className='nav-item'><Link  className='nav-link' to="/pictureOfTheDay">Picture Of The Day</Link ></li>
        <li className='nav-item'><Link className='nav-link' to="/marsRover">Mars Rover</Link ></li>
        <li className='nav-item'><Link className='nav-link' to="/">Apollo Launch</Link ></li>
